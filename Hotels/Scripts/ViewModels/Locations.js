function Locations() {
    ...
    self.setMapLocation = function (data) { 
        ...
        if (input.value === "Italy") {
            var italy = { lat: 41.9027835, lng: 12.496365500000024 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 4,
                center: italy,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Hungary") {
            var hungary = { lat: 47.497912, lng: 19.04023499999994 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 6,
                center: hungary,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Romania") {
            var romania = { lat: 44.439663, lng: 26.096306 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 4,
                center: romania,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Cluj-Napoca") {
            var cluj = { lat: 46.77121, lng: 23.623635 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 10,
                center: cluj,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Sibiu") {
            var sibiu = { lat: 45.7983273, lng: 24.12558260000003 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 10,
                center: sibiu,
                mapTypeId: 'roadmap'
        ...
        //Hotels map search
        if (input.value === "Belagio") {
            var belagio = { lat: 46.761050, lng: 23.608344 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 15,
                center: belagio,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Bianca & Oana") {
            var bianca = { lat: 45.7983273, lng: 24.12558260000003 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 15,
                center: bianca,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Hotel de Ville de Paris") {
            var france = { lat: 48.856497, lng: 2.352401 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 19,
                center: france,
                mapTypeId: 'roadmap'
        ...
        if (input.value === "Grand hotel Budapesta") {
            var hungary = { lat: 47.497912, lng: 19.04023499999994 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 20,
                center: hungary,
        ...
        if (input.value === "Berlin City Messe") {
            var germany = { lat: 52.520008, lng: 13.404954 };
            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 16,
                center: germany,
